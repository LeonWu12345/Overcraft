package com.jam8ee.overcraft.core.network;
...
public final class ModNetwork {
    ...
    public static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(
            new ResourceLocation(OvercraftMod.MODID, "main"),
            () -> PROTOCOL_VERSION,
    ...
    public static void register() {
        ...
        // ✅ 通用冷却同步（S2C）
        CHANNEL.messageBuilder(SyncCooldownsS2CPacket.class, id++)
                .encoder(SyncCooldownsS2CPacket::encode)
                .decoder(SyncCooldownsS2CPacket::decode)
